...
public class LoanSubsidyIntegrationTest {
    ...
    public void loanApplicationWithSubsidyAndEarlyPayment() {
        ...
        assertEquals("46298.65", String.valueOf(installement.get("interestDue")));

    }

    @Test
    public void loanApplicationWithSubsidyRealizationAndExactClosureWithJournalEntries() {
        ...
        // add subsidy journal entry check.
        this.journalEntryHelper.checkJournalEntryForAssetAccount(assetAccount, "01 February 2014", new JournalEntry(
                Float.valueOf("200000"), JournalEntry.TransactionType.CREDIT));
        this.journalEntryHelper.checkJournalEntryForLiabilityAccount(overpaymentAccount, "01 February 2014",
                new JournalEntry(Float.valueOf("200000"), JournalEntry.TransactionType.DEBIT));
        ...
        // add subsidy journal entry check.
        this.journalEntryHelper.checkJournalEntryForAssetAccount(assetAccount, "06 March 2014", new JournalEntry(Float.valueOf("600000"),
                JournalEntry.TransactionType.CREDIT));
        this.journalEntryHelper.checkJournalEntryForLiabilityAccount(overpaymentAccount, "06 March 2014",
                new JournalEntry(Float.valueOf("600000"), JournalEntry.TransactionType.DEBIT));
        ...
        // revoke subsidy journal entry check.
        this.journalEntryHelper.checkJournalEntryForAssetAccount(assetAccount, "20 April 2014", new JournalEntry(Float.valueOf("800000"),
                JournalEntry.TransactionType.DEBIT));
        this.journalEntryHelper.checkJournalEntryForLiabilityAccount(overpaymentAccount, "20 April 2014",
                new JournalEntry(Float.valueOf("800000"), JournalEntry.TransactionType.CREDIT));
        ...
        this.loanTransactionHelper.makeRepayment("11 August 2015", Float.valueOf("142422.07"), loanID);
        System.out.println("-------------Make repayment 27-----------");
        this.loanTransactionHelper.makeRepayment("11 August 2015", Float.valueOf("179600.81"), loanID);
        System.out.println("-------------Make repayment 28-----------");
        ...
        // realization subsidy journal entry check.
    ...
    @Test
    public void loanApplicationWithSubsidyRealizationAndExactClosureWithJournalEntriesCashBased() {
    ...
    public Integer applyForLoanApplicationWithTranches(final Integer clientID, final Integer loanProductID, String principal,
        ...
        final String loanApplicationJSON = new LoanApplicationTestBuilder()
                ...
                .withInterestCalculationPeriodTypeAsDays()
                //
                .withFixedEmiAmount(null).withMaxOutstandingLoanBalance("5000000")
