...
public class GroupLoanIndividualMonitoringHelper {
	...
	public String getClientMembersByLoanId(
			final RequestSpecification requestSpec,
			final ResponseSpecification responseSpec, final Integer loanID) {
		final String URL = GROUP_LOAN_INDIVIDUAL_MONITORING_URL + loanID + "?"
				+ Utils.TENANT_IDENTIFIER;
		final String response = Utils.performGetTextResponse(requestSpec,
				responseSpec, URL);
		return response;
	}
}
