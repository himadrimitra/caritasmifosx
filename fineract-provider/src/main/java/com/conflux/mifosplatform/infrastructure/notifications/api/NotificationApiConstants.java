...
public class NotificationApiConstants {
    ...
    public static final Set<String> NOTIFICATION_SEND_REQUEST_DATA_PARAMETERS = new HashSet<>(
            Arrays.asList(type, entityType, entitiyId, target, subject, message, providerId));
