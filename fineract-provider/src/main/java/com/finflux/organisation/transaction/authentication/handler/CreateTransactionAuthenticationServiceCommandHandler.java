...
@Service
@CommandType(entity = "TRANSACTIONAUTHENTICATIONSERVICE", action = "CREATE")
public class CreateTransactionAuthenticationServiceCommandHandler implements NewCommandSourceHandler {
	private final TransactionAuthenticationWritePlatformService transactionAuthenticationWritePlatformService;

	@Autowired
	public CreateTransactionAuthenticationServiceCommandHandler(
	...
	public CommandProcessingResult processCommand(JsonCommand command) {
		return this.transactionAuthenticationWritePlatformService.createTransactionAuthentication(command);
	}
