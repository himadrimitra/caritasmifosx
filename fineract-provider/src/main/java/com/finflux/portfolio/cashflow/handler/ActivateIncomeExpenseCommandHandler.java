...
@Service
@CommandType(entity = "INCOMEEXPENSE", action = "ACTIVATE")
public class ActivateIncomeExpenseCommandHandler implements NewCommandSourceHandler {

    private final IncomeExpenseWritePlatformService writePlatformService;

    @Autowired
    public ActivateIncomeExpenseCommandHandler(final IncomeExpenseWritePlatformService writePlatformService) {
