...
@Service
@CommandType(entity = "CASHFLOW", action = "INACTIVATE")
public class InActivateCashFlowCategoryCommandHandler implements NewCommandSourceHandler {

    private final CashFlowCategoryWritePlatformService writePlatformService;

    @Autowired
    public InActivateCashFlowCategoryCommandHandler(final CashFlowCategoryWritePlatformService writePlatformService) {
