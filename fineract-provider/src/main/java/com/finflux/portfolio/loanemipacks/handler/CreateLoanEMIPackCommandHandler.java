...
@Service
@CommandType(entity = "LOANEMIPACKS", action = "CREATE")
public class CreateLoanEMIPackCommandHandler implements NewCommandSourceHandler {

        private final LoanEMIPacksWritePlatformService writePlatformService;

        @Autowired
        public CreateLoanEMIPackCommandHandler(final LoanEMIPacksWritePlatformService writePlatformService){
