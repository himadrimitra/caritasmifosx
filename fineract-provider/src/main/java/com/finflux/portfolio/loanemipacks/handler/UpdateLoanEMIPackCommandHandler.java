...
@Service
@CommandType(entity = "LOANEMIPACKS", action = "UPDATE")
public class UpdateLoanEMIPackCommandHandler implements NewCommandSourceHandler {

        private final LoanEMIPacksWritePlatformService writePlatformService;

        @Autowired
        public UpdateLoanEMIPackCommandHandler(final LoanEMIPacksWritePlatformService writePlatformService){
