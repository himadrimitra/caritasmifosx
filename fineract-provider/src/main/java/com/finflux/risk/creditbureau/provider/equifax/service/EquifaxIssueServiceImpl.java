...
public class EquifaxIssueServiceImpl implements EquifaxIssueService {
    ...
    private CreditBureauResponse parseResponse(final String requstXml, final String responseXml,
        ...
        enquiryResponse = new EnquiryResponse(loanEnquiryReferenceData.getAcknowledgementNumber(), requstXml, responseXml, null, null,
                status, loanEnquiryReferenceData.getCbReportId());
        CreditBureauReportFile reportFile = new CreditBureauReportFile("ReportFile", responseXml.getBytes(), ReportFileType.XML);
