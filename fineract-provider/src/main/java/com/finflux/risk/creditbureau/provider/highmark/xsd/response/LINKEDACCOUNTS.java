...
public class LINKEDACCOUNTS {
    ...
    @XmlElement(name = "ACCOUNT-DETAILS", required = true)
    protected LINKEDACCOUNTS.ACCOUNTDETAILS accountdetails;
     ...
     *     
     */
    public LINKEDACCOUNTS.ACCOUNTDETAILS getACCOUNTDETAILS() {
     ...
     *     
     */
    public void setACCOUNTDETAILS(LINKEDACCOUNTS.ACCOUNTDETAILS value) {
