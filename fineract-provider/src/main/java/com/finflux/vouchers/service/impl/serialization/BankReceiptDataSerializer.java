...
@Component
public class BankReceiptDataSerializer extends DefaultVoucherDataSerializer {

    private final PaymentDetailRepository paymentDetailRepository;
    
    private final static String VOUCHER_PREFIX = "BR" ;
    
    @Autowired
    public BankReceiptDataSerializer(final FromJsonHelper fromApiJsonHelper, final GLAccountRepositoryWrapper glAccountRepositoryWrapper,
