...
public class OfficeOpeningBalancesData {
    ...
    private OfficeOpeningBalancesData(final Long officeId, final String officeName, final LocalDate transactionDate,
            ...
            final List<JournalEntryDetailData> liabityAccountOpeningBalances,
            final List<JournalEntryDetailData> incomeAccountOpeningBalances,
            final List<JournalEntryDetailData> equityAccountOpeningBalances,
            final List<JournalEntryDetailData> expenseAccountOpeningBalances) {
