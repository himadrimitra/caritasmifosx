...
public class CashBasedAccountingProcessorForSavings implements AccountingProcessorForSavings {
    ...
    public void createJournalEntriesForSavings(final SavingsDTO savingsDTO) {
        ...
        for (final SavingsTransactionDTO savingsTransactionDTO : savingsDTO.getNewSavingsTransactions()) {
            ...
            JournalEntry journalEntry = this.helper.createSavingsJournalEntry(currencyCode, transactionDate, transactionDate,
             ...
             **/
            /**
             * @TODO : Vishwas, this block of code is never entered as a separate
             *       transaction type is used for Overdraft Interest
             **/
            ...
            /**
             * @TODO : Vishwas, this block of code is never entered as a separate
             *       transaction type is used for Overdraft Fees
             **/
