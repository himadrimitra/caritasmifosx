...
@Component
public class ApproveRecurringDepositCommandStrategy implements CommandStrategy{
	
	private final RecurringDepositAccountsApiResource recurringDepositAccountsApiResource;
	
	@Autowired
	public ApproveRecurringDepositCommandStrategy(
	...
	public BatchResponse execute(BatchRequest request, UriInfo uriInfo) {
		 final BatchResponse response = new BatchResponse();
	        ...
	        try{
	            ...
	            responseBody = recurringDepositAccountsApiResource.handleCommands(RDId, "approve", uriInfo ,request.getBody());
