...
public class ExternalServicesConstants {
    ...
    public static enum AADHAAR_JSON_INPUT_PARAMS {
        HOST("host"), PORT("port"), CERTIFICATE("certificate_type"), SACODE("saCode"), SALTKEY("saltKey"), INITURL("initUrl"), KYCURL(
                "kycUrl");
    ...
    public static enum NACH_JSON_INPUT_PARAMS {
        PROCESSOR_QUALIFIER("PROCESSOR_QUALIFIER"), CORPORATE_UTILITY_CODE("CORPORATE_UTILITY_CODE"), CORPORATE_UTILITY_NAME(
                "CORPORATE_UTILITY_NAME"), SPONSOR_BANK("SPONSOR_BANK"), SPONSOR_BANK_CODE("SPONSOR_BANK_CODE");
