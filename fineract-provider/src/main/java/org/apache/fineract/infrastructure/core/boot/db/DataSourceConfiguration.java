...
public class DataSourceConfiguration {
    ...
    public DataSourceProperties dataSourceProperties() {
        return new DataSourceProperties(this.config.getDriverClassName(), this.config.getProtocol(), this.config.getSubProtocol(),
                this.config.getPort());
    }

    @Bean
    public DataSource tenantDataSourceJndi() {
        final PoolConfiguration p = getProperties();
        final org.apache.tomcat.jdbc.pool.DataSource ds = new org.apache.tomcat.jdbc.pool.DataSource(p);
