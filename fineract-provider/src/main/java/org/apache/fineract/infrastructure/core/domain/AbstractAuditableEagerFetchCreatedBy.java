 ...
 */
@MappedSuperclass
public abstract class AbstractAuditableEagerFetchCreatedBy<U, PK extends Serializable> extends AbstractPersistable<PK> implements Auditable<U, PK> {
    ...
    public void updateCreatedDate(final DateTime createdDate) {
        if (this.createdDate == null) {
