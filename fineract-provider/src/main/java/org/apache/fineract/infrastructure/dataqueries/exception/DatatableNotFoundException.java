...
public class DatatableNotFoundException extends AbstractPlatformResourceNotFoundException {
    ...
    public DatatableNotFoundException(final String datatable, final Object apptableIdentifier) {
        super("error.msg.datatable.data.not.found", "Data not found for datatable: ", datatable + "  Id:" + apptableIdentifier);
    }
