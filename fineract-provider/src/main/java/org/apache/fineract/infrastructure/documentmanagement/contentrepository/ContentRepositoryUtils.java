...
public class ContentRepositoryUtils {
    ...
    public static void validateFileSizeWithinPermissibleRange(final Long fileSize, final String name, final int maxAllowedFileSize) {
        /**
         ...
         * size is negligible
         **/
        if (fileSize != null && ((fileSize / (1024 * 1024)) > maxAllowedFileSize)) { throw new ContentManagementException(name, fileSize,
                maxAllowedFileSize); }
    }
