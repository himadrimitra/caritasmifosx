...
public class HolidayReadPlatformServiceImpl implements HolidayReadPlatformService {
    ...
    private static final class HolidayMapper implements RowMapper<HolidayData> {
        ...
        public HolidayMapper() {
            ...
            sqlBuilder.append("h.extend_repayment_schedule AS isExtendRepaymentReschedule,h.resheduling_type As repaymentSchedulingType ");
        ...
        public HolidayData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            ...
            final Long isExtendRepaymentReschedule = rs.getLong("isExtendRepaymentReschedule");
            final Integer repaymentSchedulingType = JdbcSupport.getInteger(rs, "repaymentSchedulingType");

            return new HolidayData(id, name, description, fromDate, toDate, repaymentsScheduleTO, status, isExtendRepaymentReschedule,
                    repaymentSchedulingType);
        }
    ...
    @Override
    public HolidayData retrieveHoliday(final Long holidayId) {
        try {
            final HolidayMapper rm = new HolidayMapper();
