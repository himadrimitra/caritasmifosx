...
@Service
@CommandType(entity = "CALENDAR", action = "UPDATEFUTUREMEETINGS")
public class UpdateFutureMeetingCalendarCommandHandler implements NewCommandSourceHandler{

    private final CalendarWritePlatformService calendarWritePlatformService;

    @Autowired
    public UpdateFutureMeetingCalendarCommandHandler(final CalendarWritePlatformService calendarWritePlatformService) {
