...
public class LoanChargeCannotBeUpdatedException extends AbstractPlatformDomainRuleException {
    ...
    public static enum LOAN_CHARGE_CANNOT_BE_UPDATED_REASON {
        ALREADY_PAID, ALREADY_WAIVED, LOAN_NOT_IN_SUBMITTED_AND_PENDING_APPROVAL_STAGE,GLIM_LOAN;
        ...
        public String errorMessage() {
            ...
            } else if (name().toString().equalsIgnoreCase("GLIM_LOAN")) {
                return "Glim loan charge can not be updated.";
        ...
        public String errorCode() {
            if (name().toString().equalsIgnoreCase("ALREADY_PAID")) {
                ...
                return "error.msg.glim.loan.charge.can.not.be.updated";
