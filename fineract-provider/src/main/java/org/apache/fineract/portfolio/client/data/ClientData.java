...
final public class ClientData implements Comparable<ClientData> {
    ...
    private final Collection<SavingsAccountSummaryData> savingsAccountSummaryDatas;
    ...
    public static ClientData template(final Long officeId, final LocalDate joinedDate, final Collection<OfficeData> officeOptions,
        ...
        return new ClientData(accountNo, nationalId, status, subStatus, officeId, officeName, transferToOfficeId, transferToOfficeName, id,
    ...
    public static ClientData templateOnTop(final ClientData clientData, final ClientData templateData) {
        ...
        return new ClientData(clientData.accountNo, clientData.nationalId, clientData.status, clientData.subStatus, clientData.officeId,
                ...
                clientData.mobileNo, clientData.alternateMobileNo, clientData.dateOfBirth, clientData.gender, clientData.activationDate,
                ...
                clientData.savingAccountOptions, clientData.clientType, clientData.clientClassification,
                ...
                clientData.savingsAccountSummaryDatas, templateData.closureReasons, clientData.closureReason, clientData.emailId, clientData.addressData,
                clientData.isLocked, templateData.isWorkflowEnabled, clientData.workflowId);
    ...
    public static ClientData templateWithSavingAccountOptions(final ClientData clientData,
        ...
        return new ClientData(clientData.accountNo, clientData.nationalId, clientData.status, clientData.subStatus, clientData.officeId,
                ...
                clientData.clientLegalFormOptions, clientData.legalForm, clientData.loanAccountSummaryDatas, clientData.savingsAccountSummaryDatas,
                clientData.closureReasons, clientData.closureReason, clientData.emailId, clientData.addressData, clientData.isLocked,
                clientData.isWorkflowEnabled, clientData.workflowId);
    ...
    public static ClientData setParentGroups(final ClientData clientData, final Collection<GroupGeneralData> parentGroups) {
        return new ClientData(clientData.accountNo, clientData.nationalId, clientData.status, clientData.subStatus, clientData.officeId,
                ...
                clientData.middlename, clientData.lastname, clientData.fullname, clientData.displayName, clientData.externalId,
                clientData.mobileNo, clientData.alternateMobileNo, clientData.dateOfBirth, clientData.gender, clientData.activationDate,
                clientData.imageId, clientData.staffId, clientData.staffName, clientData.officeOptions, parentGroups, clientData.staffOptions, null,
                null, clientData.timeline, clientData.savingProductOptions, clientData.savingsProductId,
    ...
    public static ClientData lookupforhierarchy(final ClientData clientData, final Collection<GroupGeneralData> parentGroups,
        ...
        return new ClientData(clientData.accountNo, clientData.nationalId, clientData.status, clientData.subStatus, officeId,
                officeName, clientData.transferToOfficeId, clientData.transferToOfficeName, clientData.id, clientData.firstname,
                clientData.middlename, clientData.lastname, clientData.fullname, clientData.displayName, clientData.externalId,
                clientData.mobileNo, clientData.alternateMobileNo, clientData.dateOfBirth, clientData.gender, clientData.activationDate,
                clientData.imageId, clientData.staffId, clientData.staffName, clientData.officeOptions, parentGroups, clientData.staffOptions, null,
                null, clientData.timeline, clientData.savingProductOptions, clientData.savingsProductId,
    ...
    public static ClientData clientIdentifier(final Long id, final String accountNo, final String nationalId, final String firstname,
            final String middlename, final String lastname, final String fullname, final String displayName, final Long officeId, final String officeName) {
        ...
        return new ClientData(accountNo, nationalId, status, subStatus, officeId, officeName, transferToOfficeId, transferToOfficeName, id,
                firstname, middlename, lastname, fullname, displayName, externalId, mobileNo, alternateMobileNo, dateOfBirth, gender,
                activationDate, imageId, staffId, staffName, allowedOffices, groups, staffOptions, closureReasons, genderOptions,
                timeline, savingProductOptions, savingsProductId, savingsProductName, savingsAccountId, savingAccountOptions,
                clientType, clientClassification, clientTypeOptions, clientClassificationOptions,
                clientNonPersonConstitutionOptions, clientNonPersonMainBusinessLineOptions, clientNonPerson, clientLegalFormOptions, legalForm,
                loanAccountSummaryDatas, savingsAccountSummaryDatas, closureReasons, closureReason, emailId, addressData, isLocked, isWorkflowEnabled, workflowId);
    }
    ...
    public static ClientData lookup(final Long id, final String displayName, final String accountNo, final Long officeId,
            final String officeName, final Long staffId, final String staffName) {
        final String nationalId = null;
        final EnumOptionData status = null;
        final CodeValueData subStatus = null;
        final Long transferToOfficeId = null;
    ...
    public static ClientData instance(final String accountNo, final String nationalId, final EnumOptionData status,
            final CodeValueData subStatus, final Long officeId, final String officeName, final Long transferToOfficeId, final String transferToOfficeName,
            final Long id, final String firstname, final String middlename, final String lastname, final String fullname,
            final String displayName, final String externalId, final String mobileNo, final String alternateMobileNo,
            ...
            final EnumOptionData legalForm, final ClientNonPersonData clientNonPerson, final CodeValueData closureReason, final String emailId,
            final boolean isLocked, final Boolean isWorkflowEnabled, final Long workflowId) {
        final Collection<OfficeData> allowedOffices = null;
        final Collection<GroupGeneralData> groups = null;
        final Collection<StaffData> staffOptions = null;
        final Collection<CodeValueData> closureReasons = null;
        ...
        return new ClientData(accountNo, nationalId, status, subStatus, officeId, officeName, transferToOfficeId, transferToOfficeName, id,
                ...
                clientClassification, clientTypeOptions, clientClassificationOptions, clientNonPersonConstitutionOptions,
                clientNonPersonMainBusinessLineOptions, clientNonPerson, clientLegalFormOptions, legalForm, loanAccountSummaryDatas, savingsAccountSummaryDatas,
    ...
    private ClientData(final String accountNo, final String nationalId, final EnumOptionData status, final CodeValueData subStatus,
            final Long officeId, final String officeName, final Long transferToOfficeId, final String transferToOfficeName,
            final Long id, final String firstname, final String middlename, final String lastname, final String fullname,
            final String displayName, final String externalId, final String mobileNo, final String alternateMobileNo,
            final LocalDate dateOfBirth, final CodeValueData gender, final LocalDate activationDate, final Long imageId, final Long staffId,
            final String staffName, final Collection<OfficeData> allowedOffices,
            ...
            final Collection<LoanAccountSummaryData> loanAccountSummaryDatas, final Collection<SavingsAccountSummaryData> savingsAccountSummaryDatas,
            final Collection<CodeValueData> closureReasons, final CodeValueData closureReason, final String emailId, final Collection<AddressData> addressData,
            final boolean isLocked, final Boolean isWorkflowEnabled, final Long workflowId) {
    ...
    public void updateAddressData(final Collection<AddressData> addressData) {
        this.addressData = addressData;
    }
}