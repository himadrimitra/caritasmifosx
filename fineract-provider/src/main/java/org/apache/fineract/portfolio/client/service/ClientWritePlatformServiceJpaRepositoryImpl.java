...
public class ClientWritePlatformServiceJpaRepositoryImpl implements ClientWritePlatformService {
    ...
    public CommandProcessingResult deleteClient(final Long clientId) {
        ...
        this.businessEventNotifierService.notifyBusinessEventToBeExecuted(BUSINESS_EVENTS.CLIENT_DELETE,
                constructEntityMap(BUSINESS_ENTITY.ENTITY_LOCK_STATUS, client.isLocked()));
    ...
    private CommandProcessingResult openSavingsAccount(final Client client, final DateTimeFormatter fmt) {
        ...
        if (client.isActive() && client.savingsProductId() != null) {
            final SavingsProduct savingsProduct = this.savingsProductRepository.findOne(client.savingsProductId());
            Staff staff = null;
            SavingsAccountDataDTO savingsAccountDataDTO = new SavingsAccountDataDTO(client, null, savingsProduct, staff,
