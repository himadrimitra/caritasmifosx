...
@Service
@CommandType(entity = CollateralsApiConstants.PRODUCT_COLLATERALS_MAPPING_RESOURCE_NAME, action = "DELETE")
public class DeleteProductCollateralsMappingCommandHandler implements NewCommandSourceHandler{
    
    private final ProductCollateralsMappingWritePlatformService productCollateralsMappingWritePlatformService;
    
    @Autowired
    private DeleteProductCollateralsMappingCommandHandler(
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        ...
        return this.productCollateralsMappingWritePlatformService.deleteProductCollateralsMapping(command.subentityId());
    }
}
