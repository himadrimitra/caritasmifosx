...
public class CollectionSheetWritePlatformServiceJpaRepositoryImpl implements CollectionSheetWritePlatformService {
    ...
    public CommandProcessingResult updateCollectionSheet(final JsonCommand command) {
        ...
        final List<CollectionSheetTransactionDetails> collectionSheetTransactionDetails = new ArrayList<>();
        final CollectionSheet collectionSheet = CollectionSheet.formCollectionSheet(officeId, staffId, groupId, centerId,
        ...
        if (searchParmeterJson != null) {
            ...
            final Long collectionSheetId = collectionSheet.getId();
    ...
    private Map<String, Object> updateClientCharges(final JsonCommand command, final PaymentDetail paymentDetail,
            final List<CollectionSheetTransactionDetails> collectionSheetTransactionDetails) {
        final Map<String, Object> changes = new HashMap<>();
