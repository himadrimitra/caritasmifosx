...
//    @CacheEvict(value = "funds", key = "T(org.apache.fineract.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat('fn')")
    ...
    private String getLoanAssignmentCriteria() {
        ...
        criteria = " l.loan_status_id IN "+FundApiConstants.fundAssignmentValidLoanStatusAsString+" AND (l.fund_id IS NULL OR l.fund_id IN (" + fundIdAsString + "))  AND l.loan_type_enum in (" + AccountType.INDIVIDUAL.getValue() + " ," + AccountType.JLG.getValue() + ") ";
        return criteria;
    }
