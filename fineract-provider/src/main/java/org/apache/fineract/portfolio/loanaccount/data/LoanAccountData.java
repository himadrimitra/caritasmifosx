...
public class LoanAccountData {
    ...
    public static LoanAccountData collateralTemplate(final Collection<CodeValueData> loanCollateralOptions) {
        ...
        return new LoanAccountData(id, accountNo, status, externalId, clientId, clientAccountNo, clientName, clientOfficeId, group,
                ...
                closureLoanId, closureLoanAccountNo, topupAmount, weeksInYearType, paymentOptions, expectedDisbursalPaymentType,
                expectedRepaymentPaymentType, clientData, loanEMIPacks, brokenPeriodMethodType, brokenPeriodMethodTypeOptions,
                brokenPeriodInterest, considerFutureDisbursmentsInSchedule, considerAllDisbursementsInSchedule, discountOnDisbursalAmount,
                allowUpfrontCollection, amountForUpfrontCollection, calculatedEmiAmount, interestRatesListPerPeriod, isLocked);
    ...
    public static LoanAccountData basicLoanDetailsForDataLookup(final Long id, final String accountNo, final LoanStatusEnumData status,
            ...
            final LoanApplicationTimelineData timeline, final PaymentTypeData expectedDisbursalPaymentType,
            final PaymentTypeData expectedRepaymentPaymentType) {
        ...
        return new LoanAccountData(id, accountNo, status, externalId, clientId, clientAccountNo, clientName, clientOfficeId, group,
                ...
                isFloatingInterestRate, interestRateDifferential, interestCalculationPeriodType, allowPartialPeriodInterestCalcualtion,
                expectedFirstRepaymentOnDate, graceOnPrincipalPayment, recurringMoratoriumOnPrincipalPeriods, graceOnInterestPayment,
                graceOnInterestCharged, interestChargedFromDate, timeline, summary, feeChargesDueAtDisbursementCharged, repaymentSchedule,
                transactions, charges, collateral, guarantors, calendarData, productOptions, termFrequencyTypeOptions,
                repaymentFrequencyTypeOptions, repaymentFrequencyNthDayTypeOptions, repaymentFrequencyDayOfWeekTypeOptions,
    ...
    public static LoanAccountData loanDetailsForTaskLookup(final Long id, final String accountNo, final LoanStatusEnumData status,
            final Long clientId, final String clientAccountNo, final String clientName, final Long loanProductId,
            final String loanProductName, final Long loanPurposeId, final String loanPurposeName, final Long loanOfficerId,
            final String loanOfficerName, final EnumOptionData loanType, final BigDecimal principal,
            final PaymentTypeData expectedDisbursalPaymentType, final GroupGeneralData group) {
        final String externalId = null;
        final Long clientOfficeId = null;
        final String loanProductDescription = null;
        final Long fundId = null;
    ...
    public static LoanAccountData populateClientDefaults(final LoanAccountData acc, final LoanAccountData clientAcc) {
        ...
        return new LoanAccountData(acc.id, acc.accountNo, acc.status, acc.externalId, clientAcc.clientId, clientAcc.clientAccountNo,
                ...
                acc.annualInterestRate, acc.flatInterestRate, acc.interestType, acc.isFloatingInterestRate, acc.interestRateDifferential,
                ...
                acc.weeksInYearType, acc.paymentOptions, acc.expectedDisbursalPaymentType, acc.expectedRepaymentPaymentType,
                clientAcc.clientData, acc.loanEMIPacks, acc.brokenPeriodMethodType, acc.brokenPeriodMethodTypeOptions,
                acc.brokenPeriodInterest, acc.considerFutureDisbursmentsInSchedule, acc.considerAllDisbursementsInSchedule,
                acc.discountOnDisbursalAmount, acc.allowUpfrontCollection, acc.amountForUpfrontCollection, acc.calculatedEmiAmount,
                acc.interestRatesListPerPeriod, acc.isLocked);
    }
    ...
    public static LoanAccountData populateGroupDefaults(final LoanAccountData acc, final LoanAccountData groupAcc) {
        ...
        return new LoanAccountData(acc.id, acc.accountNo, acc.status, acc.externalId, acc.clientId, acc.clientAccountNo, acc.clientName,
                ...
                acc.flatInterestRate, acc.interestType, acc.isFloatingInterestRate, acc.interestRateDifferential,
                acc.interestCalculationPeriodType, acc.allowPartialPeriodInterestCalcualtion, acc.expectedFirstRepaymentOnDate,
                acc.graceOnPrincipalPayment, acc.recurringMoratoriumOnPrincipalPeriods, acc.graceOnInterestPayment,
                acc.graceOnInterestCharged, acc.interestChargedFromDate, groupAcc.timeline, acc.summary,
                acc.feeChargesAtDisbursementCharged, acc.repaymentSchedule, acc.transactions, acc.charges, acc.collateral, acc.guarantors,
                acc.meeting, acc.productOptions, acc.termFrequencyTypeOptions, acc.repaymentFrequencyTypeOptions,
                acc.repaymentFrequencyNthDayTypeOptions, acc.repaymentFrequencyDaysOfWeekTypeOptions,
                acc.transactionProcessingStrategyOptions, acc.interestRateFrequencyTypeOptions, acc.amortizationTypeOptions,
                ...
                acc.loanEMIPacks, acc.brokenPeriodMethodType, acc.brokenPeriodMethodTypeOptions, acc.brokenPeriodInterest,
                acc.considerFutureDisbursmentsInSchedule, acc.considerAllDisbursementsInSchedule, acc.discountOnDisbursalAmount,
                acc.allowUpfrontCollection, acc.amountForUpfrontCollection, acc.calculatedEmiAmount, acc.interestRatesListPerPeriod,
                acc.isLocked);
    ...
    public static LoanAccountData loanProductWithTemplateDefaults(final LoanProductData product,
            ...
            final Collection<EnumOptionData> brokenPeriodMethodTypeOptions) {
        ...
        if (product.useBorrowerCycle() && loanCycleNumber > 0) {
            final Collection<LoanProductBorrowerCycleVariationData> principalVariationsForBorrowerCycle = product
            ...
            final Collection<LoanProductBorrowerCycleVariationData> repaymentVariationsForBorrowerCycle = product
            ...
            final BigDecimal numberofRepaymentval = fetchLoanCycleDefaultValue(repaymentVariationsForBorrowerCycle, loanCycleNumber);
        ...
        return new LoanAccountData(id, accountNo, status, externalId, clientId, clientAccountNo, clientName, clientOfficeId, group,
                ...
                transactionProcessingStrategyCode, transactionProcessingStrategyName, product.getAmortizationType(), interestRatePerPeriod,
                product.getInterestRateFrequencyType(), product.getAnnualInterestRate(), flatInterestRate, product.getInterestType(),
                ...
                closureLoanAccountNo, topupAmount, weeksInYearType, paymentOptions, expectedDisbursalPaymentType,
                expectedRepaymentPaymentType, clientData, loanEMIPacks, product.getBrokenPeriodMethodType(), brokenPeriodMethodTypeOptions,
                brokenPeriodInterest, considerFutureDisbursmentsInSchedule, considerAllDisbursementsInSchedule, discountOnDisbursalAmount,
                product.allowUpfrontCollection(), amountForUpfrontCollection, calculatedEmiAmount, interestRatesListPerPeriod, isLocked);
    }
    ...
    public static LoanAccountData populateLoanProductDefaults(final LoanAccountData acc, final LoanProductData product) {
        ...
        return new LoanAccountData(acc.id, acc.accountNo, acc.status, acc.externalId, acc.clientId, acc.clientAccountNo, acc.clientName,
                ...
                acc.pledgeId, acc.interestRatesPeriods, product.isVariableInstallmentsAllowed(), product.getMinimumGapBetweenInstallments(),
                ...
                product.getBrokenPeriodMethodType(), acc.brokenPeriodMethodTypeOptions, acc.brokenPeriodInterest,
                acc.considerFutureDisbursmentsInSchedule, acc.considerAllDisbursementsInSchedule, acc.discountOnDisbursalAmount,
                product.allowUpfrontCollection(), acc.amountForUpfrontCollection, acc.calculatedEmiAmount, acc.interestRatesListPerPeriod,
                acc.isLocked);
    ...
    public static LoanAccountData basicLoanDetails(final Long id, final String accountNo, final LoanStatusEnumData status,
            final String externalId, final Long clientId, final String clientAccountNo, final String clientName, final String mobileNo,
            final Long clientOfficeId, final GroupGeneralData group, final EnumOptionData loanType, final Long loanProductId,
            final String loanProductName, final String loanProductDescription, final boolean isLoanProductLinkedToFloatingRate,
            ...
            final Integer repaymentEvery, final EnumOptionData repaymentFrequencyType, final EnumOptionData repaymentFrequencyNthDayType,
            final EnumOptionData repaymentFrequencyDayOfWeekType, final Long transactionStrategyId,
            final String transactionProcessingStrategyCode, final String transactionStrategyName, final EnumOptionData amortizationType,
            ...
            final EnumOptionData interestType, final boolean isFloatingInterestRate, final BigDecimal interestRateDifferential,
            ...
            final Integer loanProductCounter, final Boolean multiDisburseLoan, final Boolean canDefineInstallmentAmount,
            ...
            final Boolean isVariableInstallmentsAllowed, final Integer minimumGap, final Integer maximumGap, final EnumOptionData subStatus,
            final boolean canUseForTopup, final boolean isTopup, final Long closureLoanId, final String closureLoanAccountNo,
            final BigDecimal topupAmount, final EnumOptionData weeksInYearType, final PaymentTypeData expectedDisbursalPaymentType,
            final PaymentTypeData expectedRepaymentPaymentType, final EnumOptionData brokenPeriodMethodType,
            final BigDecimal flatInterestRate, final BigDecimal brokenPeriodInterest, final Boolean considerFutureDisbursmentsInSchedule,
            final Boolean considerAllDisbursementsInSchedule, final BigDecimal discountOnDisbursalAmount,
        ...
        final Collection<EnumOptionData> brokenPeriodMethodTypeOptions = null;
        final Collection<Float> interestRatesListPerPeriod = null;
        return new LoanAccountData(id, accountNo, status, externalId, clientId, clientAccountNo, clientName, mobileNo, clientOfficeId,
                group, loanType, loanProductId, loanProductName, loanProductDescription, isLoanProductLinkedToFloatingRate, fundId,
                fundName, loanPurposeId, loanPurposeName, loanOfficerId, loanOfficerName, currencyData, proposedPrincipal, principal,
                approvedPrincipal, totalOverpaid, inArrearsTolerance, termFrequency, termPeriodFrequencyType, numberOfRepayments,
                repaymentEvery, repaymentFrequencyType, repaymentFrequencyNthDayType, repaymentFrequencyDayOfWeekType,
                ...
                isVariableInstallmentsAllowed, minimumGap, maximumGap, subStatus, canUseForTopup, clientActiveLoanOptions, isTopup,
                closureLoanId, closureLoanAccountNo, topupAmount, weeksInYearType, paymentOptions, expectedDisbursalPaymentType,
                expectedRepaymentPaymentType, clientData, brokenPeriodMethodType, brokenPeriodMethodTypeOptions, brokenPeriodInterest,
                considerFutureDisbursmentsInSchedule, considerAllDisbursementsInSchedule, discountOnDisbursalAmount, allowUpfrontCollection,
                amountForUpfrontCollection, calculatedEmiAmount, interestRatesListPerPeriod, isLocked);
    }
    ...
    public static LoanAccountData associationsAndTemplate(final LoanAccountData acc, final LoanScheduleData repaymentSchedule,
            ...
            final Collection<InterestRatePeriodData> interestRatesPeriods, final Collection<LoanAccountSummaryData> clientActiveLoanOptions,
            final Collection<EnumOptionData> brokenPeriodMethodTypeOptions, final Collection<Float> interestRatesListPerPeriod) {
        ...
        return new LoanAccountData(acc.id, acc.accountNo, acc.status, acc.externalId, acc.clientId, acc.clientAccountNo, acc.clientName,
                ...
                interestRatesPeriods, acc.isVariableInstallmentsAllowed, acc.minimumGap, acc.maximumGap, acc.subStatus, acc.canUseForTopup,
                clientActiveLoanOptions, acc.isTopup, acc.closureLoanId, acc.closureLoanAccountNo, acc.topupAmount, acc.weeksInYearType,
                acc.paymentOptions, acc.expectedDisbursalPaymentType, acc.expectedRepaymentPaymentType, acc.clientData, acc.loanEMIPacks,
                acc.brokenPeriodMethodType, brokenPeriodMethodTypeOptions, acc.brokenPeriodInterest,
                acc.considerFutureDisbursmentsInSchedule, acc.considerAllDisbursementsInSchedule, acc.discountOnDisbursalAmount,
                acc.allowUpfrontCollection, acc.amountForUpfrontCollection, acc.calculatedEmiAmount, interestRatesListPerPeriod,
                acc.isLocked);
    }
    ...
    public static LoanAccountData associateMemberVariations(final LoanAccountData acc, final Map<Long, Integer> memberLoanCycle) {
        ...
        for (final Map.Entry<Long, Integer> mapEntry : memberLoanCycle.entrySet()) {
            BigDecimal principal = null;
            BigDecimal interestRatePerPeriod = null;
            Integer numberOfRepayments = null;
            Collection<Float> interestRatesListPerPeriod = null;
            final Long clientId = mapEntry.getKey();
            final Integer loanCycleNumber = mapEntry.getValue();
            if (acc.product.useBorrowerCycle() && loanCycleNumber != null && loanCycleNumber > 0) {
                final Collection<LoanProductBorrowerCycleVariationData> principalVariationsForBorrowerCycle = acc.product
                        .getPrincipalVariationsForBorrowerCycle();
                final Collection<LoanProductBorrowerCycleVariationData> interestForVariationsForBorrowerCycle = acc.product
                        .getInterestRateVariationsForBorrowerCycle();
                final Collection<LoanProductBorrowerCycleVariationData> repaymentVariationsForBorrowerCycle = acc.product
                        .getNumberOfRepaymentVariationsForBorrowerCycle();
                principal = fetchLoanCycleDefaultValue(principalVariationsForBorrowerCycle, loanCycleNumber);
                interestRatePerPeriod = fetchLoanCycleDefaultValue(interestForVariationsForBorrowerCycle, loanCycleNumber);
                interestRatesListPerPeriod = fetchLoanCycleInteresetRates(interestForVariationsForBorrowerCycle, loanCycleNumber);
            ...
            final LoanBorrowerCycleData borrowerCycleData = new LoanBorrowerCycleData(principal, interestRatePerPeriod, numberOfRepayments,
                    termFrequency);
    ...
    private LoanAccountData(final Long id, //
            ...
            final CurrencyData currency, final BigDecimal proposedPrincipal, final BigDecimal principal, final BigDecimal approvedPrincipal,
            ...
            final Long transactionProcessingStrategyId, final String transactionProcessingStrategyCode,
            ...
            final EnumOptionData interestRateFrequencyType, final BigDecimal annualInterestRate, final BigDecimal flatInterestRate,
            final EnumOptionData interestType, final boolean isFloatingInterestRate, final BigDecimal interestRateDifferential,
            final EnumOptionData interestCalculationPeriodType, final Boolean allowPartialPeriodInterestCalcualtion,
            final LocalDate expectedFirstRepaymentOnDate, final Integer graceOnPrincipalPayment,
            final Integer recurringMoratoriumOnPrincipalPeriods, final Integer graceOnInterestPayment, final Integer graceOnInterestCharged,
            ...
            final Collection<NoteData> notes, final Collection<PortfolioAccountData> accountLinkingOptions,
            final PortfolioAccountData linkedAccount, final Collection<DisbursementData> disbursementDetails,
            final Boolean multiDisburseLoan, final Boolean canDefineInstallmentAmount, final BigDecimal fixedEmiAmount,
            ...
            final String closureLoanAccountNo, final BigDecimal topupAmount, final EnumOptionData weeksInYearType,
            final Collection<PaymentTypeData> paymentOptions, final PaymentTypeData expectedDisbursalPaymentType,
            final PaymentTypeData expectedRepaymentPaymentType, final ClientData clientData, final Collection<LoanEMIPackData> loanEMIPacks,
            final EnumOptionData brokenPeriodMethodType, final Collection<EnumOptionData> brokenPeriodMethodTypeOptions,
            final BigDecimal brokenPeriodInterest, final Boolean considerFutureDisbursmentsInSchedule,
            final Boolean considerAllDisbursementsInSchedule, final BigDecimal discountOnDisbursalAmount,
            final Boolean allowUpfrontCollection, final BigDecimal amountForUpfrontCollection, final BigDecimal calculatedEmiAmount,
            final Collection<Float> interestRatesListPerPeriod, final boolean isLocked) {
    ...
    private LoanAccountData(final Long id, //
            ...
            final LoanStatusEnumData status, //
            final String externalId, //
            final Long clientId, final String clientAccountNo, final String clientName, final String mobileNo, final Long clientOfficeId, //
            final GroupGeneralData group, final EnumOptionData loanType, final Long loanProductId, final String loanProductName,
            final String loanProductDescription, //
            final boolean isLoanProductLinkedToFloatingRate, final Long fundId, final String fundName, final Long loanPurposeId,
            final String loanPurposeName, //
            ...
            final String closureLoanAccountNo, final BigDecimal topupAmount, final EnumOptionData weeksInYearType,
            final Collection<PaymentTypeData> paymentOptions, final PaymentTypeData expectedDisbursalPaymentType,
            final PaymentTypeData expectedRepaymentPaymentType, final ClientData clientData, final EnumOptionData brokenPeriodMethodType,
            final Collection<EnumOptionData> brokenPeriodMethodTypeOptions, final BigDecimal brokenPeriodInterest,
            final Boolean considerFutureDisbursmentsInSchedule, final Boolean considerAllDisbursementsInSchedule,
            final BigDecimal discountOnDisbursalAmount, final Boolean allowUpfrontCollection, final BigDecimal amountForUpfrontCollection,
            final BigDecimal calculatedEmiAmount, final Collection<Float> interestRatesListPerPeriod, final boolean isLocked) {
    ...
    public RepaymentScheduleRelatedLoanData repaymentScheduleRelatedData() {
        ...
        if (this.brokenPeriodMethodType != null
                && BrokenPeriodMethod.fromInt(this.brokenPeriodMethodType.getId().intValue()).isPostInterest()) {
            interestPostedAmount = this.brokenPeriodInterest;
        }
        BigDecimal discountedFromPrincipal = BigDecimal.ZERO;
        if (this.discountOnDisbursalAmount != null && !isActive()) {
            discountedFromPrincipal = this.discountOnDisbursalAmount;
        }

        final boolean considerFutureDisbursmentsInSchedule = this.considerFutureDisbursmentsInSchedule == null ? false
                : this.considerFutureDisbursmentsInSchedule;
        return this.timeline.repaymentScheduleRelatedData(this.currency, this.principal, this.approvedPrincipal, this.inArrearsTolerance,
                this.feeChargesAtDisbursementCharged, interestPostedAmount, considerFutureDisbursmentsInSchedule,
                this.considerAllDisbursementsInSchedule, discountedFromPrincipal);
    }
    ...
    private static BigDecimal fetchLoanCycleDefaultValue(final Collection<LoanProductBorrowerCycleVariationData> borrowerCycleVariationData,
            final Integer loanCycleNumber) {
        BigDecimal defaultValue = null;
        Integer cycleNumberSelected = 0;
        for (final LoanProductBorrowerCycleVariationData data : borrowerCycleVariationData) {
    ...
    public static Collection<Float> fetchLoanCycleInteresetRates(
            final Collection<LoanProductBorrowerCycleVariationData> borrowerCycleVariationData, final Integer loanCycleNumber) {
    ...
    private static boolean isLoanCycleValuesWhenConditionGreterthan(final Integer loanCycleNumber, final Integer cycleNumberSelected,
            final LoanProductBorrowerCycleVariationData data) {
    ...
    private static boolean isLoanCycleValuesWhenConditionEqual(final Integer loanCycleNumber,
            final LoanProductBorrowerCycleVariationData data) {
    ...
    public void setProduct(final LoanProductData product) {
        this.product = product;
    }
    ...
    public void setPaymentOptions(final Collection<PaymentTypeData> paymentOptions) {
        this.paymentOptions = paymentOptions;
    }
    ...
    public static LoanAccountData basicLoanDetails(final Long id, final String accountNo, final LoanStatusEnumData status,
            final String externalId, final Long clientId, final GroupGeneralData groupData, final EnumOptionData loanType,
            final Long loanProductId, final Long fundId, final Long loanPurposeId, final Long loanOfficerId,
            ...
            final BigDecimal feeChargesDueAtDisbursementCharged, final Boolean syncDisbursementWithMeeting, final Integer loancounter,
            final Integer loanProductCounter, final BigDecimal fixedEmiAmount, final BigDecimal outstandingLoanBalance,
            final Boolean inArrears, final Integer graceOnArrearsAgeing, final Boolean isNPA, final EnumOptionData daysInMonthType,
            final EnumOptionData daysInYearType, final boolean isInterestRecalculationEnabled,
            final LoanInterestRecalculationData interestRecalculationData, final Boolean createStandingInstructionAtDisbursement,
            final EnumOptionData subStatus, final boolean isTopup, final EnumOptionData weeksInYearType,
            final PaymentTypeData expectedDisbursalPaymentType, final PaymentTypeData expectedRepaymentPaymentType,
            final EnumOptionData brokenPeriodMethodType, final BigDecimal flatInterestRate, final BigDecimal brokenPeriodInterest,
            final BigDecimal discountOnDisbursalAmount, final BigDecimal amountForUpfrontCollection) {
        ...
        final boolean isLocked = false;
        return new LoanAccountData(id, accountNo, status, externalId, clientId, clientAccountNo, clientName, mobileNo, clientOfficeId,
                groupData, loanType, loanProductId, loanProductName, loanProductDescription, isLoanProductLinkedToFloatingRate, fundId,
                fundName, loanPurposeId, loanPurposeName, loanOfficerId, loanOfficerName, currencyData, proposedPrincipal, principal,
                approvedPrincipal, totalOverpaid, inArrearsTolerance, termFrequency, termPeriodFrequencyType, numberOfRepayments,
                repaymentEvery, repaymentFrequencyType, repaymentFrequencyNthDayType, repaymentFrequencyDayOfWeekType,
                transactionStrategyId, transactionProcessingStrategyCode, transactionProcessingStrategyName, amortizationType,
                interestRatePerPeriod, interestRateFrequencyType, annualInterestRate, flatInterestRate, interestType,
                isFloatingInterestRate, interestRateDifferential, interestCalculationPeriodType, allowPartialPeriodInterestCalcualtion,
                expectedFirstRepaymentOnDate, graceOnPrincipalPayment, recurringMoratoriumOnPrincipalPeriods, graceOnInterestPayment,
                graceOnInterestCharged, interestChargedFromDate, timeline, loanSummary, feeChargesDueAtDisbursementCharged,
    ...
    public BigDecimal getPrincipal() {
        BigDecimal ret = this.principal;
        ret = (ret == null) ? this.approvedPrincipal : ret;
        ret = (ret == null) ? this.proposedPrincipal : ret;
        return ret;
    }
    ...
    public static LoanAccountData loanDetailsForPDCLookUp(final Long id, final String accountNo, final LoanStatusEnumData status,
