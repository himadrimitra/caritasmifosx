...
public class LoanTransactionData {
    ...
    public LoanTransactionData(final Long id, final Long officeId, final String officeName, final LoanTransactionEnumData transactionType,
            ...
            final AccountTransferData transfer, final BigDecimal fixedEmiAmount, final BigDecimal outstandingLoanBalance,
    ...
    public LoanTransactionData(final Long id, final Long officeId, final String officeName, final LoanTransactionEnumData transactionType,
            ...
            final BigDecimal fixedEmiAmount, final BigDecimal outstandingLoanBalance, final boolean manuallyReversed) {
        this(id, officeId, officeName, transactionType, paymentDetailData, currency, date, amount, principalPortion, interestPortion,
    ...
    public LoanTransactionData(final Long id, final Long officeId, final String officeName, final LoanTransactionEnumData transactionType,
            ...
            final BigDecimal principalPortion, final BigDecimal interestPortion, final BigDecimal feeChargesPortion,
            final BigDecimal penaltyChargesPortion, final BigDecimal overpaymentPortion, final BigDecimal unrecognizedIncomePortion,
            final String externalId, final AccountTransferData transfer, final BigDecimal fixedEmiAmount,
            final BigDecimal outstandingLoanBalance, final LocalDate submittedOnDate, final boolean manuallyReversed) {
        this(id, officeId, officeName, transactionType, paymentDetailData, currency, date, amount, principalPortion, interestPortion,
                feeChargesPortion, penaltyChargesPortion, overpaymentPortion, unrecognizedIncomePortion, null, externalId, transfer,
    ...
    public static LoanTransactionData populateLoanTransactionData(final Long id, final BigDecimal amount) {
        ...
        return new LoanTransactionData(id, officeId, officeName, transactionType, paymentDetailData, currency, date, amount,
                principalPortion, interestPortion, feeChargesPortion, penaltyChargesPortion, overpaymentPortion, unrecognizedIncomePortion,
                paymentTypeOptions, externalId, transfer, fixedEmiAmount, outstandingLoanBalance, submittedOnDate, manuallyReversed);
    }
    ...
    public LoanTransactionData(final Long id, final Long officeId, final String officeName, final LoanTransactionEnumData transactionType,
            ...
            final BigDecimal penaltyChargesPortion, final BigDecimal overpaymentPortion, final BigDecimal unrecognizedIncomePortion,
            final Collection<PaymentTypeData> paymentTypeOptions, final String externalId, final AccountTransferData transfer,
            final BigDecimal fixedEmiAmount, final BigDecimal outstandingLoanBalance, final LocalDate submittedOnDate,
    ...
    public LoanTransactionData(final Long id, final Long officeId, final String officeName, final LoanTransactionEnumData transactionType,
            ...
            final Collection<PaymentTypeData> paymentTypeOptions, final String externalId, final AccountTransferData transfer,
            final BigDecimal fixedEmiAmount, final BigDecimal outstandingLoanBalance, final LocalDate submittedOnDate,
            final boolean manuallyReversed, final LocalDateTime createdDate, final LocalDateTime updatedDate, final AppUserData createdBy,
            final AppUserData updatedBy, final List<GroupLoanIndividualMonitoringTransactionData> glimTransactions) {
        this.id = id;
        this.officeId = officeId;
        this.officeName = officeName;
        this.type = transactionType;
    ...
    public LoanTransactionData(final Long id, final LoanTransactionEnumData transactionType, final LocalDate date,
            final BigDecimal totalAmount, final BigDecimal principalPortion, final BigDecimal interestPortion,
            final BigDecimal feeChargesPortion, final BigDecimal penaltyChargesPortion, final BigDecimal overPaymentPortion,
            final BigDecimal unrecognizedIncomePortion, final BigDecimal outstandingLoanBalance, final boolean manuallyReversed) {
    ...
    public static LoanTransactionData LoanTransactionDataForDisbursalTemplate(final LoanTransactionEnumData transactionType,
            ...
            final LocalDate possibleNextRepaymentDate, final Collection<TransactionAuthenticationData> transactionAuthenticationOptions,
    ...
    private LoanTransactionData(final Long id, final Long officeId, final String officeName, final LoanTransactionEnumData transactionType,
            final PaymentDetailData paymentDetailData, final CurrencyData currency, final LocalDate date, final BigDecimal amount,
            final BigDecimal principalPortion, final BigDecimal interestPortion, final BigDecimal feeChargesPortion,
            final BigDecimal penaltyChargesPortion, final BigDecimal overpaymentPortion, final BigDecimal unrecognizedIncomePortion,
            final Collection<PaymentTypeData> paymentOptions, final AccountTransferData transfer, final String externalId,
            final BigDecimal fixedEmiAmount, final BigDecimal outstandingLoanBalance, final LocalDate submittedOnDate,
    ...
    public static LoanTransactionData LoanTransactionDataForReconciliationLoanTransactionData(final Long id, final Long officeId,
            final String officeName, final LoanTransactionEnumData transactionType, final LocalDate date, final BigDecimal amount,
    ...
    public static LoanTransactionData LoanTransactionRepaymentTemplate(final LoanTransactionData loanTransactionData,
            final LoanAccountData loanAccountData) {
    ...
    public static LoanTransactionData LoanTransactionRefundData(final LoanTransactionEnumData transactionType, final LocalDate date,
        ...
        return new LoanTransactionData(id, officeId, officeName, transactionType, paymentDetailData, currency, date, amount,
                principalPortion, interestPortion, feeChargesPortion, penaltyChargesPortion, overpaymentPortion, unrecognizedIncomePortion,
                paymentOptions, transfer, externalId, retriveLastEmiAmount, outstandingLoanBalance, submittedOnDate, manuallyReversed,
                possibleNextRepaymentDate, transactionAuthenticationOptions, fingerPrintData);
    ...
    public void setWriteOffReasonOptions(final Collection<CodeValueData> writeOffReasonOptions) {
    ...
    public void setLoanOverdueData(final LoanOverdueData loanOverdueData) {
    ...
    public void setLoanOverdueChargeData(final LoanOverdueChargeData loanOverdueChargeData) {
