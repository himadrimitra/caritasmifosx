...
public class InvalidRefundDateException extends AbstractPlatformDomainRuleException {
    ...
    public InvalidRefundDateException(final String errorMsg, final String refundDateAsString, final String defaultUserMessage) {
        super(errorMsg, defaultUserMessage, new Object[] { refundDateAsString });
    }
