...
public class LoanRescheduleRequestReadPlatformServiceImpl implements LoanRescheduleRequestReadPlatformService {
    ...
    public LoanRescheduleRequestReadPlatformServiceImpl(final RoutingDataSource dataSource,
            final LoanReadPlatformService loanReadPlatformService, final CodeValueReadPlatformService codeValueReadPlatformService) {
    ...
    private static final class LoanRescheduleRequestRowMapper implements RowMapper<LoanRescheduleRequestData> {
        ...
        public LoanRescheduleRequestData mapRow(final ResultSet rs, final int rowNum) throws SQLException {
            ...
            final Collection<LoanTermVariationsData> loanTermVariations = new ArrayList<>();

            do {
                final Long tempId = rs.getLong("id");
                if (id.equals(tempId)) {
    ...
    @Override
    public List<LoanRescheduleRequestData> readLoanRescheduleRequests(final Long loanId) {
    ...
    @Override
    public LoanRescheduleRequestData readLoanRescheduleRequest(final Long requestId) {
    ...
    @Override
    public List<LoanRescheduleRequestData> readLoanRescheduleRequests(final Long loanId, final Integer statusEnum) {
        this.loanReadPlatformService.validateForLoanExistence(loanId);
    ...
    @Override
    public List<Long> retriveActiveLoanRescheduleRequestVariations(final Long loanId) {
    ...
    @Override
    public List<LoanRescheduleRequestData> retrieveAllRescheduleRequests(final String command) {
        final LoanRescheduleRequestRowMapperForBulkApproval loanRescheduleRequestRowMapperForBulkApproval = new LoanRescheduleRequestRowMapperForBulkApproval();
