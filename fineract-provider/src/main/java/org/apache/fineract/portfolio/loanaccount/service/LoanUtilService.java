...
public class LoanUtilService {
    ...
    public Integer calculateMinimumDaysBetweenDisbursalAndFirstRepayment(final LocalDate disbursalDate,
        ...
        public Integer calculateMinimumDaysBetweenDisbursalAndFirstRepayment(final LocalDate disbursalDate,
                final Loan loan, Integer nthDay, DayOfWeekType dayOfWeek) {
