...
public final class PaymentDetail extends AbstractPersistable<Long> {
    ...
    public static PaymentDetail instance(final PaymentType paymentType, final String checkNumber, final String bankNumber, final String branchName, final Date paymentDate) {
