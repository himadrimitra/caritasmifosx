...
public class PaymentTypeApiResource {
    ...
    public PaymentTypeApiResource(PlatformSecurityContext securityContext, DefaultToApiJsonSerializer<PaymentTypeData> jsonSerializer,
            ...
            final BankAccountDetailsReadService bankAccountDetailsReadService, final ExternalServicesReadService externalServicesReadService) {
        super();
    ...
    public String retrieveOnePaymentType(@PathParam("paymentTypeId") final Long paymentTypeId, @Context final UriInfo uriInfo) {
        ...
        if (paymentTypes.getExternalServiceId() != null) {
            BankAccountDetailData bankAccountDetailData = this.bankAccountDetailsReadService.retrieveOneBy(
                    BankAccountDetailEntityType.PAYMENTTYPES, paymentTypeId);
