...
public class DepositAccountInterestRateChartData {
    ...
    public static DepositAccountInterestRateChartData instance(final Long id, final String name, final String description,
            final LocalDate fromDate, final LocalDate endDate, final boolean isPrimaryGroupingByAmount, final Long accountId,
            final String accountNumber, final Collection<DepositAccountInterestRateChartSlabData> chartSlabs,
    ...
    public static DepositAccountInterestRateChartData from(final InterestRateChartData productChartData) {
        final Long id = null;
        final Long accountId = null;
        final String accountNumber = null;
        final Collection<DepositAccountInterestRateChartSlabData> fromProdChartSlabs = new ArrayList<>();
        final Collection<InterestRateChartSlabData> productChartSlabDatas = productChartData.chartSlabs();
        if (productChartSlabDatas != null) {
            for (final InterestRateChartSlabData productChartSlabData : productChartSlabDatas) {
    ...
    public static DepositAccountInterestRateChartData withSlabs(final DepositAccountInterestRateChartData interestRateChartData,
    ...
    public static DepositAccountInterestRateChartData withTemplate(final DepositAccountInterestRateChartData interestRateChartData,
    ...
    public static DepositAccountInterestRateChartData template(final Collection<EnumOptionData> periodTypes,
    ...
    private DepositAccountInterestRateChartData(final Long id, final String name, final String description, final LocalDate fromDate,
            final LocalDate endDate, final boolean isPrimaryGroupingByAmount, final Long accountId, final String accountNumber,
            final Collection<DepositAccountInterestRateChartSlabData> chartSlabs, final Collection<EnumOptionData> periodTypes,
            final Collection<EnumOptionData> entityTypeOptions, final Collection<EnumOptionData> attributeNameOptions,
            final Collection<EnumOptionData> conditionTypeOptions, final Collection<EnumOptionData> incentiveTypeOptions,
            final Collection<CodeValueData> genderOptions, final Collection<CodeValueData> clientTypeOptions,
            final Collection<CodeValueData> clientClassificationOptions) {
