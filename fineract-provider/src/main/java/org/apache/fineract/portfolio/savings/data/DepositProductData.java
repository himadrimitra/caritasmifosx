...
public class DepositProductData {
    ...
    protected final boolean isInterestCalculationFromProductChart;
    ...
    public static DepositProductData template(final CurrencyData currency, final EnumOptionData interestCompoundingPeriodType,
            ...
            final Collection<TaxGroupData> taxGroupOptions, boolean isInterestCalculationFromProductChart) {
    ...
    public static DepositProductData withTemplate(final DepositProductData existingProduct, final Collection<CurrencyData> currencyOptions,
        ...
        return new DepositProductData(existingProduct.id, existingProduct.name, existingProduct.shortName, existingProduct.description,
                ...
                existingProduct.withHoldTax, existingProduct.taxGroup, taxGroupOptions, existingProduct.externalId, existingProduct.isInterestCalculationFromProductChart);
    }
    ...
    public static DepositProductData withAccountingDetails(final DepositProductData existingProduct,
        ...
        return new DepositProductData(existingProduct.id, existingProduct.name, existingProduct.shortName, existingProduct.description,
                ...
                existingProduct.minBalanceForInterestCalculation, existingProduct.withHoldTax, existingProduct.taxGroup, taxGroupOptions, existingProduct.externalId,
                existingProduct.isInterestCalculationFromProductChart);
    }
    ...
    public static DepositProductData instance(final Long id, final String name, final String shortName, final String description,
            ...
            final BigDecimal minBalanceForInterestCalculation, boolean withHoldTax, TaxGroupData taxGroup, String externalId, boolean isInterestCalculationFromProductChart) {
    ...
    public static DepositProductData withInterestChart(final DepositProductData existingProduct,
        ...
        return new DepositProductData(existingProduct.id, existingProduct.name, existingProduct.shortName, existingProduct.description,
                ...
                existingProduct.taxGroup, existingProduct.taxGroupOptions, existingProduct.externalId, existingProduct.isInterestCalculationFromProductChart);
    }
    ...
    protected DepositProductData(final Long id, final String name, final String shortName, final String description,
            ...
            final Collection<TaxGroupData> taxGroupOptions, String externalId, boolean isInterestCalculationFromProductChart) {
