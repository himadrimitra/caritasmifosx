...
public class DepositProductDataValidator {
    ...
    @Autowired
    public DepositProductDataValidator(final FromJsonHelper fromApiJsonHelper, final InterestRateChartDataValidator chartDataValidator) {
    ...
    public void validateForFixedDepositUpdate(final String json) {
        ...
        validateDepositDetailForUpdate(element, this.fromApiJsonHelper, baseDataValidator);
    ...
    private void validateDepositDetailForCreate(final JsonElement element, final FromJsonHelper fromApiJsonHelper,
        ...
        if (isCashBasedAccounting(accountingRuleType)) {
            ...
            final Long savingsControlAccountId = fromApiJsonHelper
                    .extractLongNamed(SAVINGS_PRODUCT_ACCOUNTING_PARAMS.SAVINGS_CONTROL.getValue(), element);
            ...
            final Long savingsReferenceAccountId = fromApiJsonHelper
                    .extractLongNamed(SAVINGS_PRODUCT_ACCOUNTING_PARAMS.SAVINGS_REFERENCE.getValue(), element);
            ...
            final Long transfersInSuspenseAccountId = fromApiJsonHelper
                    .extractLongNamed(SAVINGS_PRODUCT_ACCOUNTING_PARAMS.TRANSFERS_SUSPENSE.getValue(), element);
            ...
            final Long interestOnSavingsAccountId = fromApiJsonHelper
                    .extractLongNamed(SAVINGS_PRODUCT_ACCOUNTING_PARAMS.INTEREST_ON_SAVINGS.getValue(), element);
            ...
            final Long incomeFromPenaltyId = fromApiJsonHelper
                    .extractLongNamed(SAVINGS_PRODUCT_ACCOUNTING_PARAMS.INCOME_FROM_PENALTIES.getValue(), element);
    ...
    public void validatePreClosureDetailForCreate(final JsonElement element, final DataValidatorBuilder baseDataValidator) {
        if (this.fromApiJsonHelper.parameterExists(preClosurePenalApplicableParamName, element)) {
            final boolean preClosurePenalApplicable = this.fromApiJsonHelper.extractBooleanNamed(preClosurePenalApplicableParamName,
                    element);

            if (preClosurePenalApplicable) {
                final BigDecimal penalInterestRate = this.fromApiJsonHelper
                        .extractBigDecimalWithLocaleNamed(preClosurePenalInterestParamName, element);
    ...
    public void validatePreClosurePenalInterest(final JsonElement element, final DataValidatorBuilder baseDataValidator) {
        ...
        if (topLevelJsonElement.has(chartsParamName) && topLevelJsonElement.get(chartsParamName).isJsonArray()) {
            ...
            for (int i = 0; i < array.size(); i++) {
                ...
                if (interestRateChartElement.has(chartSlabs) && interestRateChartElement.get(chartSlabs).isJsonArray()) {
                    final JsonArray chartslabs = interestRateChartElement.get(chartSlabs).getAsJsonArray();
                    if (chartslabs.size() != 0
                            && this.fromApiJsonHelper.parameterExists(annualInterestRateParamName, chartslabs.get(chartslabs.size() - 1))) {
                        ...
                        final Integer preClosurePenalInterest = this.fromApiJsonHelper.extractIntegerNamed(preClosurePenalInterestParamName,
                                element, locale);
                        baseDataValidator.reset().parameter(annualInterestRateParamName).value(annualInterestRate)
                                .integerGreaterThanNumber(preClosurePenalInterest);
                    }
                }
            }
        }
    ...
    public void validateDepositTermDeatilForCreate(final JsonElement element, final DataValidatorBuilder baseDataValidator) {
        ...
        if (this.fromApiJsonHelper.parameterExists(inMultiplesOfDepositTermParamName, element)) {
            final Integer inMultiplesOfDepositTerm = this.fromApiJsonHelper.extractIntegerSansLocaleNamed(inMultiplesOfDepositTermParamName,
                    element);
    ...
    private void validateChartsData(final JsonElement element, final DataValidatorBuilder baseDataValidator) {
    ...
    public void validateDepositDetailForUpdate(final JsonElement element, final FromJsonHelper fromApiJsonHelper,
        ...
        final Long savingsReferenceAccountId = fromApiJsonHelper
                .extractLongNamed(SAVINGS_PRODUCT_ACCOUNTING_PARAMS.SAVINGS_REFERENCE.getValue(), element);
        baseDataValidator.reset().parameter(SAVINGS_PRODUCT_ACCOUNTING_PARAMS.SAVINGS_REFERENCE.getValue()).value(savingsReferenceAccountId)
                .ignoreIfNull().integerGreaterThanZero();
    ...
    public void validatePreClosureDetailForUpdate(final JsonElement element, final DataValidatorBuilder baseDataValidator) {
        if (this.fromApiJsonHelper.parameterExists(preClosurePenalApplicableParamName, element)) {
            final Boolean preClosurePenalApplicable = this.fromApiJsonHelper.extractBooleanNamed(preClosurePenalApplicableParamName,
                    element);
        ...
        if (this.fromApiJsonHelper.parameterExists(preClosurePenalInterestParamName, element)) {
            final BigDecimal penalInterestRate = this.fromApiJsonHelper.extractBigDecimalWithLocaleNamed(preClosurePenalInterestParamName,
                    element);
            baseDataValidator.reset().parameter(preClosurePenalInterestParamName).value(penalInterestRate).notNull().zeroOrPositiveAmount();
        }

        if (this.fromApiJsonHelper.parameterExists(preClosurePenalInterestOnTypeIdParamName, element)) {
            final Integer preClosurePenalInterestType = this.fromApiJsonHelper
                    .extractIntegerSansLocaleNamed(preClosurePenalInterestOnTypeIdParamName, element);
    ...
    public void validateDepositTermDetailForUpdate(final JsonElement element, final DataValidatorBuilder baseDataValidator) {
        ...
        if (this.fromApiJsonHelper.parameterExists(inMultiplesOfDepositTermTypeIdParamName, element)) {
            final Integer inMultiplesOfDepositTermType = this.fromApiJsonHelper
                    .extractIntegerSansLocaleNamed(inMultiplesOfDepositTermTypeIdParamName, element);
            baseDataValidator.reset().parameter(inMultiplesOfDepositTermTypeIdParamName).value(inMultiplesOfDepositTermType)
                    .isOneOfTheseValues(SavingsPeriodFrequencyType.integerValues());
    ...
    private void validatePaymentChannelFundSourceMappings(final FromJsonHelper fromApiJsonHelper,
        ...
        if (fromApiJsonHelper.parameterExists(SAVINGS_PRODUCT_ACCOUNTING_PARAMS.PAYMENT_CHANNEL_FUND_SOURCE_MAPPING.getValue(), element)) {
            final JsonArray paymentChannelMappingArray = fromApiJsonHelper
                    .extractJsonArrayNamed(SAVINGS_PRODUCT_ACCOUNTING_PARAMS.PAYMENT_CHANNEL_FUND_SOURCE_MAPPING.getValue(), element);
            if (paymentChannelMappingArray != null && paymentChannelMappingArray.size() > 0) {
                ...
                do {
                    ...
                    final Long paymentTypeId = this.fromApiJsonHelper
                            .extractLongNamed(SAVINGS_PRODUCT_ACCOUNTING_PARAMS.PAYMENT_TYPE.getValue(), jsonObject);
                    final Long paymentSpecificFundAccountId = this.fromApiJsonHelper
                            .extractLongNamed(SAVINGS_PRODUCT_ACCOUNTING_PARAMS.FUND_SOURCE.getValue(), jsonObject);
                    baseDataValidator.reset()
                            .parameter(SAVINGS_PRODUCT_ACCOUNTING_PARAMS.PAYMENT_CHANNEL_FUND_SOURCE_MAPPING.getValue() + "."
    ...
    private void validateChargeToIncomeAccountMappings(final FromJsonHelper fromApiJsonHelper, final DataValidatorBuilder baseDataValidator,
        ...
        validateChargeToIncomeAccountMappings(fromApiJsonHelper, baseDataValidator, element, false);
            ...
            if (chargeToIncomeAccountMappingArray != null && chargeToIncomeAccountMappingArray.size() > 0) {
                ...
                do {
                    ...
                    final Long incomeAccountId = fromApiJsonHelper
                            .extractLongNamed(SAVINGS_PRODUCT_ACCOUNTING_PARAMS.INCOME_ACCOUNT_ID.getValue(), jsonObject);
                    baseDataValidator.reset().parameter(parameterName + "." + SAVINGS_PRODUCT_ACCOUNTING_PARAMS.CHARGE_ID.getValue())
                            .value(chargeId).notNull().integerGreaterThanZero();
                    baseDataValidator.reset()
                            .parameter(parameterName + "." + SAVINGS_PRODUCT_ACCOUNTING_PARAMS.INCOME_ACCOUNT_ID.getValue())
    ...
    public void validateRecurringDetailForCreate(final JsonElement element, final DataValidatorBuilder baseDataValidator) {
    ...
    public void validateRecurringDepositUpdate(final JsonElement element, final DataValidatorBuilder baseDataValidator) {
