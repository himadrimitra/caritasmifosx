...
public class SearchApiResource {
    ...
    public String searchData(@Context final UriInfo uriInfo, @QueryParam("query") final String query,
            @QueryParam("resource") final String resource, @DefaultValue("false") @QueryParam("exactMatch") final Boolean exactMatch,
            @QueryParam("officeId") final Long officeId) {

        final SearchConditions searchConditions = new SearchConditions(query, resource, exactMatch, officeId);
