...
public class RolesApiResource {
    ...
    /**
     * The set of parameters that are supported in response for {@link RolePermissionsData}
     */
    ...
    public String retrieveRole(@PathParam("roleId") final Long roleId, @Context final UriInfo uriInfo) {
        ...
        if(settings.isTemplate()){
            List<CurrencyData> allowedCurrencies = (List<CurrencyData>) currencyReadPlatformService.retrieveAllowedCurrencies();
