...
public class RoleReadPlatformServiceImpl implements RoleReadPlatformService {
    ...
    public RoleData retrieveOne(final Long id) {
        ...
        try {
            ...
            List<RoleData> roleDatas = this.jdbcTemplate.query(sql, this.roleExtractor, new Object[] { id });
            if(roleDatas == null || roleDatas.isEmpty()){
                throw new RoleNotFoundException(id);
            }
            RoleData roleData = roleDatas.get(0);
            return roleData;
    ...
    protected static final class RoleWithRoleBasedLimitsExtractor implements ResultSetExtractor<List<RoleData>> {
        ...
        @Override
        public List<RoleData> extractData(ResultSet rs) throws SQLException {

            Map<Long, RoleData> roleDatasMap = new HashMap<>();
            ...
            while (rs.next()) {
                ...
                if (roleData == null) {
                    ...
                    List<RoleBasedLimitData> roleBasedLimits = new ArrayList<>();;
                ...
                if (roleBasedLimitId != null) {
                    ...
                    CurrencyData currencyData = new CurrencyData(code, name, decimalPlaces, inMultiplesOf, displaySymbol, nameCode);
        ...
        public String schema() {
            StringBuilder stringBuilder = new StringBuilder(
                    "select r.id as id, r.name as name, r.description as description, r.is_disabled as disabled, rbl.currency_id, ")
