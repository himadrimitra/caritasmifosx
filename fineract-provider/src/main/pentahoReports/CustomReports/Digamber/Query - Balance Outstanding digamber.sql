...
,ifnull(lp.name,'NA') loanPurpose,ifnull(c.external_id,'NA'),mcv.code_value
from m_office o 
...
left join f_loan_purpose lp on lp.id=l.loan_purpose_id
left join m_code_value mcv on c.client_type_cv_id=mcv.id
...
and tx.transaction_type_enum in (1,2)
