...
INSERT INTO `stretchy_report` (`report_name`, `report_type`, `report_subtype`, `report_category`, `report_sql`, `description`, `core_report`, `use_report`, `track_usage`) VALUES ('Collection ReportSEF', 'Pentaho', NULL, 'Custom', '(NULL)', '(NULL)', 1, 1, 0);
