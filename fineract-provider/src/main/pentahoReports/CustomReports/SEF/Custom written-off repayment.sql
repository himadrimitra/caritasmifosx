...
INSERT INTO `stretchy_report` (`report_name`, `report_type`, `report_subtype`, `report_category`, `report_sql`, `description`, `core_report`, `use_report`, `track_usage`) VALUES ('Custom written-off repayment', 'Pentaho', NULL, 'Custom', NULL, NULL, 0, 1, 0);
...
INSERT INTO `stretchy_report_parameter` (`report_id`, `parameter_id`, `report_parameter_name`) VALUES ((select id from `stretchy_report` where report_name='Custom written-off repayment'), (select id from `stretchy_parameter` where parameter_name='startDateSelect'), 'enddate');
