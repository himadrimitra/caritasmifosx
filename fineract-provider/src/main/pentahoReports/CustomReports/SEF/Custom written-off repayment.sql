...
INSERT INTO `stretchy_report` (`report_name`, `report_type`, `report_subtype`, `report_category`, `report_sql`, `description`, `core_report`, `use_report`, `track_usage`) VALUES ('Custom written-off repayment', 'Pentaho', NULL, 'Client', NULL, NULL, 0, 1, 0);
