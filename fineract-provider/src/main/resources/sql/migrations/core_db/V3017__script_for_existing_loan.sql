CREATE TABLE `f_existing_loan` (
	...
	PRIMARY KEY (`id`),
	INDEX `FK__m_client` (`client_id`),
	INDEX `FK__m_code_value` (`source_cv_id`),
	INDEX `FK__m_code_value_bureau` (`bureau_cv_id`),
	INDEX `FK__m_code_value_lender` (`lender_cv_id`),
	INDEX `FK__m_code_value_loantype` (`loantype_cv_id`),
	INDEX `FK_f_existing_loan_m_appuser` (`createdby_id`),
	INDEX `FK_f_existing_loan_m_appuser_last_Modified` (`lastmodifiedby_id`),
	INDEX `FK_f_existing_loan_m_code_value` (`external_loan_purpose_cv_id`),
	CONSTRAINT `FK_f_existing_loan_m_appuser` FOREIGN KEY (`createdby_id`) REFERENCES `m_appuser` (`id`),
	...
	CONSTRAINT `FK__m_code_value` FOREIGN KEY (`source_cv_id`) REFERENCES `m_code_value` (`id`),
	CONSTRAINT `FK__m_code_value_bureau` FOREIGN KEY (`bureau_cv_id`) REFERENCES `m_code_value` (`id`),
