...
INSERT INTO `m_permission` (`grouping`, `code`, `entity_name`, `action_name`, `can_maker_checker`) 
	VALUES ('transaction_loan', 'SUBSIDYADD_LOAN_CHECKER', 'LOAN', 'SUBSIDYADD_CHECKER', 0),
		('transaction_loan', 'SUBSIDYADD_LOAN', 'LOAN', 'SUBSIDYADD', 0),
		('transaction_loan', 'SUBSIDYREVOKE_LOAN', 'LOAN', 'SUBSIDYREVOKE', 0),
		('transaction_loan', 'SUBSIDYREVOKE_LOAN_CHECKER', 'LOAN', 'SUBSIDYREVOKE_CHECKER', 0),
		('transaction_loan', 'READ_SUBSIDY', 'LOAN', 'READ', 0);
